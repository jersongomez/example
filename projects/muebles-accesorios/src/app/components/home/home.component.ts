...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.partnerFacade.getInfoPartnertByName(Constants.ALIADO_MUEBLES_Y_ACCESORIOS);
  ...
  buildCalculateFeeRq(
    ...
    return {
      aliado: Constants.ALIADO_MUEBLES_Y_ACCESORIOS,
  ...
  logoutSesion(){
    ...
    const dialogRef = this.dialog.open(ModalComponent, {
          data: { tipoModal: 'closeInactive', aliado: 'MueblesyAccesorios'  },
          disableClose: true,
          width: '35%',
        });
  }
